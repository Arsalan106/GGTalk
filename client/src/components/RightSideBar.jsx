...
const RightSideBar = ({ selectedUsers, setSelectedtUsers }) => {
  return selectedUsers && (
    <div className='h-full bg-gray-100/8 flex flex-col items-center p-4'>
      ...
      <div className='text-xs px-5'>
        ...
        <button className=' flex justify-center  absolute bottom-0 mb-3 bg-blue-600 w-[150px] rounded-2xl p-1 cursor-pointer  hover:scale-105 transition duration-300 ease-in-out'>Logout</button>
    </div>
  )
}
